...
# 6. A common statistical operation on a dataset is centering. This means to adjust 
# the data such that the mean of the data is 0. This is done by subtracting the mean 
...
# Exercise 1 - Make a variable called sum_of_a to hold the sum of all the numbers in 
# above list
...
# Exercise 3 - refactor the following maximum calculation to find the answer with 
# numpy.
...
# Exercise 12 - reshape the array b to be a list of 6 lists, each containing only 
# 1 number (6 x 1)
